...
All the environments are registered in the `isaac_lab_quadruped` extension. They start
...
import isaac_lab_quadruped.tasks  # noqa: F401


def main():
    """Print all environments registered in `isaac_lab_quadruped` extension."""
